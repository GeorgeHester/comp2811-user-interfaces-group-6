...
QT_MOC_LITERAL(1, 7, 18), // "rightButtonClicked"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "Header\0rightButtonClicked\0"
};
...
void Header::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->rightButtonClicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Header::rightButtonClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Header::rightButtonClicked()
{
