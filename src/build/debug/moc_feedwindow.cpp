...
QT_MOC_LITERAL(5, 43, 4) // "from"
    ...
    "FeedWindow\0currentWindowUpdated\0\0"
    "Window\0to\0from"
};
...
void FeedWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (FeedWindow::*)(Window , Window );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FeedWindow::currentWindowUpdated)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject FeedWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_FeedWindow.data,
...
// SIGNAL 0
void FeedWindow::currentWindowUpdated(Window _t1, Window _t2)
{
