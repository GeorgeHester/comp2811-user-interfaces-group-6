...
QT_MOC_LITERAL(1, 14, 20), // "currentWindowUpdated"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 6), // "Window"
QT_MOC_LITERAL(4, 43, 2), // "to"
QT_MOC_LITERAL(5, 46, 4) // "from"

    },
    "CaptureWindow\0currentWindowUpdated\0\0"
    "Window\0to\0from"
};
...
void CaptureWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CaptureWindow::*)(Window , Window );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CaptureWindow::currentWindowUpdated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CaptureWindow::currentWindowUpdated(Window _t1, Window _t2)
{
