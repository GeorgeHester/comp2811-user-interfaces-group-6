...
QT_MOC_LITERAL(1, 7, 21), // "selectedWindowUpdated"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 5) // "index"

    },
    "Footer\0selectedWindowUpdated\0\0index"
};
...
void Footer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Footer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->selectedWindowUpdated((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Footer::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Footer::selectedWindowUpdated)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Footer::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Footer.data,
    qt_meta_data_Footer,
    qt_static_metacall,
    nullptr,
    nullptr
...
// SIGNAL 0
void Footer::selectedWindowUpdated(int _t1)
{
